...
def main():
    ...
    # --- Generate HTML email for GitHub Actions ---
    ...
    <body>
      <p>Hello,</p>
      <p>Based on <b>{meta['change_id']}</b>, AI-assisted Linux OS patching has been completed.</p>
      ...
      <td>{total}</td>
        ...
        <td>See attachment for more details</td>
      </tr>
    </table>
    <h3>New Relic Infra & APM Status</h3>
    <table border="1" cellpadding="6" cellspacing="0">
      <tr>
        <th>NR Reporting</th>
        <th>APM</th>
      ...
      <td>{nr_reporting}</td>
        <td>{apm_total}</td>
        <td style="color:green;"><b>{apm_green}</b></td>
        <td style="color:red;"><b>{apm_red}</b></td>
      </tr>
      </table>
      <p>Operations team, please review the attached reports and take action for failed servers.</p>
      <br>
