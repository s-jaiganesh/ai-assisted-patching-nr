...
TIMEOUT = 20
MASTER_PROMPT = """
You are an enterprise DevOps assistant enhancing Teams notifications.
Rules:
- Max 3 lines
- No emojis
- No markdown
...
- Add only useful insights (failures, risks, actions)
"""
...
def notify_event(use_teams: bool, webhook: str, event_type: str, data: dict):
    ...
    try:
        ...
        user_prompt = build_llm_prompt(payload)
        ai_extra = call_llm(system_prompt, user_prompt)
